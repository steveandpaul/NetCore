   ...
   public class DBC
    {
        ...
        //NetDBTransation NetDBTransation;

        public DbTransaction dbTransaction;
        #region 构造函数重载
        public DBC(string key=null)
        {
            ...
            //  NetDBTransation = new NetDBTransation(dBDriver.GetDbTransaction());
        ...
        public DBC(string constr, string key = null)
        {
            string DB_TYPE = GetDBTYype.instance;
            SQL_TYPE = DB_TYPE;
            switch (DB_TYPE)
